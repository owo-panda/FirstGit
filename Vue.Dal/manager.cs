...
namespace Vue.DAL
{
    ...
    public partial class manager
    {
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from vue_manager");
        ...
        public int Add(Model.manager model)
        {
            ...
            strSql.Append("insert into vue_manager(");
        ...
        public bool Update(Model.manager model)
        {
            ...
            PropertyInfo[] pros = model.GetType().GetProperties();
            List<SqlParameter> paras = new List<SqlParameter>();
            strSql.Append("update vue_manager set ");
            foreach (PropertyInfo pi in pros)
            {
                //如果不是主键则追加sql字符串
                if (!pi.Name.Equals("Id"))
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from vue_manager ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
                    new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        public Model.manager GetModel(int id)
        {
            ...
            strSql.Append(" from vue_manager");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
                    new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM vue_manager");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id from vue_manager");
